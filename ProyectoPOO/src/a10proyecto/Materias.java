...
public class Materias extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jRadioButton1.setText("Consultar por grupo");

        jRadioButton2.setText("Consultar por clave");

        jRadioButton3.setText("Registrar materia");

        jRadioButton4.setText("Modificar materia");

        jRadioButton5.setText("Eliminar materia");

        jRadioButton6.setText("Menú");
